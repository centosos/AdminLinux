...
Скачаем исходные пакеты и установим зависимости
...
Редактируем спеку, чтобы билдить вместе с `openssl`

```diff
$ sudo yum install -y rpm-build perl gcc nano make
$ diff -u --color=always _nginx.spec rpmbuild/SPECS/nginx.spec | less -R
--- _nginx.spec 2020-12-20 16:58:52.910925190 +0000
+++ rpmbuild/SPECS/nginx.spec   2020-12-20 16:59:09.288831471 +0000
@@ -122,6 +122,7 @@
...
Осталось убедиться, что пакеты создались
...
● nginx.service - nginx - high performance web server
   ...
   Active: active (running) since Sun 2020-12-20 17:30:47 UTC; 3s ago
...
Dec 20 17:30:47 localhost.localdomain systemd[1]: Starting nginx - high performance web server...
Dec 20 17:30:47 localhost.localdomain systemd[1]: nginx.service: Can't open PID file /var/run/nginx.pid (yet?) after start: No such file or directory
Dec 20 17:30:47 localhost.localdomain systemd[1]: Started nginx - high performance web server.
```
...
==============================================================================================================================================================================================
Reinstalling:
 nginx                                     x86_64                                     1:1.18.0-2.el7.ngx                                        moi                                     2.1 M
...
```bash
$ yum list | grep moi
nginx.x86_64                                1:1.18.0-2.el7.ngx         @moi     
```

Всё есть! Репозиторий работает
